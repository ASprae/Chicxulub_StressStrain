...
for i in np.arange(1,model.nsteps,1):
    ...
    tran = np.linalg.lstsq(locs_m, locs_n, rcond = None)
...
DATA = [I, t_av, x_loc, y_loc, rot, rot_cum, gam_xy, gam_xy_cum, I1, I2, I3, J2_e, R_I1, R_I2, R_I3, e_val1, e_vec1x, e_vec1y, e_vec1z, e_val2, e_vec2x, e_vec2y, e_vec2z, e_val3, e_vec3x, e_vec3y, e_vec3z, Wk, Wk_strain, n_oct_unit_shear, lode, Distension, STRESS_I1, STRESS_I2, STRESS_I3, STRESS_e_val1, STRESS_e_vec1x, STRESS_e_vec1y, STRESS_e_vec1z, STRESS_e_val2, STRESS_e_vec2x, STRESS_e_vec2y, STRESS_e_vec2z, STRESS_e_val3, STRESS_e_vec3x, STRESS_e_vec3y, STRESS_e_vec3z, pre, temp, dist]
for i in DATA:
    i = np.array(i)
DATA = np.array(DATA, dtype = object)
DATA = DATA.T

np.savetxt('{}/{}/output.txt'.format(namemodel, dirname), DATA, delimiter=' ', header="TIME x y rot rot_cum gam_xy gam_xy_cum e_I1 e_I2 e_I3 e_J2 e_R_I1 e_R_I2 e_R_I3 e_e_val1 e_e_vec1x e_e_vec1y e_e_vec1z e_e_val2 e_e_vec2x e_e_vec2y e_e_vec2z e_e_val3 e_e_vec3x e_e_vec3y e_e_vec3z Wk Wk_strain n_oct_unit_shear lode Distension S_I1 S_I2 S_I3 S_e_val1 S_e_vec1x S_e_vec1y S_e_vec1z S_e_val2 S_e_vec2x S_e_vec2y S_e_vec2z S_e_val3 S_e_vec3x S_e_vec3y S_e_vec3z P T Alpha")
